...
- **cli_command:** `.\run_categorized_corpus.py --corpus .\data\wiki_tree_corpus_for_cka.jsonl --out_dir .\outputs\my_run11 --models F:\quantas\models\google\gemma-3-1b-it F:\quantas\models\Qwen\Qwen3.5-0.8B --aggregation_level document --words 200 --max_new_tokens 1500 --match_abstract_length --word_count_prompt --summarize --batch_size 4 --chunk_size 768 --stage all`
